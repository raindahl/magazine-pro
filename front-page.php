...
//* YouTube video below Header
add_action( 'genesis_before_content', 'sk_youtube_video', 9 );
function sk_youtube_video() {
 
	echo '<div class="below-header-video"style="padding-bottom:20px;"><iframe width="100%" height="500" src="//www.youtube.com/embed/24Z8YWkaCXc" frameborder="0" allowfullscreen></iframe></div>';
}
genesis();
